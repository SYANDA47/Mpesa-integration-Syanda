...
align-items: center;
background: linear-gradient(#080808  0,#4ba9e9 50%,#ff004f 50%,#fff 100%);
min-height: 100vh;
  ...
  .button button i {
   ...
   <body>
    <div class="card">
        ...
        <img src="mark2.jpg" alt="mark2">
        </div>
        <div class="details">
            <h3>Toyota Mark X<br><span>X-WISH</span></h3>
            <h4>Product Details</h4>
            <p>Devsy Hacks Motors pride's itself on blending modernised and well furnished motor vehicles to ensure that you ride on a comfortable luxurious machine..</p>
            <h4>Tyre Size</h4>
            <ul class="Tyre size">
                <li>16</li>
                <li>19</li>
            ...
            <div class="card__container">
                <div class="card">
                    <div class="row">
                        ...
                        <p style="color:#8F92C3;line-height:1.7;">1. Enter the <b>phone number</b> and press "<b>Pay for Products</b>"</br>2. You will receive an STK push on your phone. Enter your <b>MPESA PIN</b></p>
                        <?php if ($errmsg != ''): ?>
                    ...
                    <div class="row number">
                        <div class="info">
                            ...
                            <input id="cardnumber" type="text" name="phone_number" maxlength="10" placeholder="07********" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="button">
                <button type="submit"><i class="ion-locked"></i> Pay for Products</button>
            </div>
                        </div>
        </form>
   <p style="position: absolute; bottom: 0; color: violet; line-height: 1.7; margin: 0">Copyright 2022 | All Rights Reserved | Made by <i class="fab fa-gratipay"></i>Devsy Hacks</p>
</div>
